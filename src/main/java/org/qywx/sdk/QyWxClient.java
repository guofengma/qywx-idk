...
import org.qywx.sdk.base.request.AccessTokenGetRequest;
import org.qywx.sdk.base.request.HttpRequestTools;
import org.qywx.sdk.base.response.AccessTokenGetRespone;
import org.qywx.sdk.common.Dom4jUtil;
import java.io.File;
...
public class QyWxClient {
    private final static Logger logger = Logger.getLogger(QyWxClient.class.getName());
    
    /** 微信接口请求凭证 {@link QyWxToken} */
    private QyWxToken wxToken;
    /** 接口凭证字符串 */
     ...
     * 构建微信接口客户端
     * @author Rocye
     * @param wxToken	微信接口请求凭证 {@link QyWxToken}
     */
    public QyWxClient(QyWxToken wxToken) {
     ...
     */
    public QyWxClient(String accessToken) {
    ...
    public String getAccessToken() {
        ...
        if(tokenMap != null){
            ...
            AccessTokenGetRequest accessTokenGetReq = new AccessTokenGetRequest(this.wxToken.getCorpId(), this.wxToken.getCorpSecret());
