...
import org.qywx.sdk.user.response.UserUpdateRespone;
 ...
 * @version 2018.03.12
 */
public class UserUpdateRequest implements Request<UserUpdateRespone> {
    /** 应用接口唯一凭证 */
    ...
    public String getApiUrl(){
        String url = "https://qyapi.weixin.qq.com/cgi-bin/user/update?access_token="+ this.accessToken;
        return url;
    }
	 ...
	 * @param builder	构建器
	 */
	public UserUpdateRequest(Builder builder) {
     ...
     * 获取返回对象类
     */
    public Class<UserUpdateRespone> getResponseClass(){
        return UserUpdateRespone.class;
    }
