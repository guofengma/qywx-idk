 ...
 * @version 2018.2.26
 */
public class UserSimpleListRequest implements Request<UserSimpleListRespone> {
    /** 应用接口唯一凭证 */
    ...
    public String getApiUrl(){
        String url = "https://qyapi.weixin.qq.com/cgi-bin/user/simplelist?access_token="+ this.accessToken;
	 ...
	 */
	public UserSimpleListRequest(Integer departmentId) {
	 ...
	 */
	public UserSimpleListRequest(Integer departmentId, Integer fetchChild) {
		this.department_id = departmentId;
     ...
     * 获取返回对象类
     */
    public Class<UserSimpleListRespone> getResponseClass(){
        return UserSimpleListRespone.class;
    }
